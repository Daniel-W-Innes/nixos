...
func NewDeleteMessagesParams() *DeleteMessagesParams {
	return NewDeleteMessagesParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DeleteMessagesParams].
