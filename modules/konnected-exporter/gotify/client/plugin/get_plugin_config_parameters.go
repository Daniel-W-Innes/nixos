...
func NewGetPluginConfigParams() *GetPluginConfigParams {
	return NewGetPluginConfigParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [GetPluginConfigParams].
