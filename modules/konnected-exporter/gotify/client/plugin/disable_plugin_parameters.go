...
func NewDisablePluginParams() *DisablePluginParams {
	return NewDisablePluginParamsWithTimeout(cr.DefaultTimeout)
}
...
//
// Deprecated: use the operation call with context to pass the context instead of [DisablePluginParams].
