...
- melon = `localhost:*` instances; onion = `onion.lc.brotherwolf.ca:*` (9100 node, 9256 process, 9633 smartctl, 9835 nvidia). onion scrapes at 60 s cadence are the cheap LAN-health probe.
